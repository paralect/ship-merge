...
filesToRemove=( ".drone.yml" "docker-compose.yml" "LICENSE" "CHANGELOG.md CODE_OF_CONDUCT.md" )
...
repositoryActions() {
    ...
    git filter-branch --tree-filter "GLOBIGNORE='n*'; rm ${files[*]}; mkdir -p ../temp_path; mv * ../temp_path; mkdir $2; mv ../temp_path/* $2/; unset GLOBIGNORE" --force HEAD
